...
const ZH_CORE: Record<string, string> = {
    ...
    'Wikilink': '双链',
    'Character relation': '人物关系',
    'This node has no vault file': '该节点没有对应笔记文件',
    'Character relations need character nodes': '人物关系需要两端都是角色节点',
    'Pick a different node': '请选择另一个节点',
    'Wikilink added': '已添加双链',
    'Wikilink already present': '双链已存在',
    'Failed to add wikilink': '添加双链失败',
    'Back to Story Graph': '返回故事图谱',
    'Save perceptions': '保存看法',
    'How they see each other': '对对方的看法',
    'Surface': '表面',
    'Deep': '深层',
    'Surface — {name} about {other}': '表面 — {name} 对 {other}',
    'Deep — {name} about {other}': '深层 — {name} 对 {other}',
    'Write the surface-level impression…': '写下表层印象…',
    'Write the deeper feeling…': '写下深层感受…',
    'Perceptions saved': '已保存看法',
    'Failed to save perceptions': '保存看法失败',
    'Both endpoints need vault files to open focus view.': '两端都需要有对应笔记文件才能打开聚焦视图。',
    'Both endpoints must be characters to open focus view.': '聚焦视图仅支持两端都是角色的连线。',
    'Arrow style': '箭头形式',
    'Single arrow': '单箭头',
    'Double arrow': '双箭头',
    'Single arrow follows the wikilink direction; double arrow is mutual.': '单箭头沿双链方向；双箭头表示双向互指。',
    'Create semantic categories for Obsidian wikilinks. Choose single or double arrows per category; right-click a graph edge to assign one.': '为 Obsidian 双链创建关联类别，并可自选单箭头或双箭头；在图谱连线上右键即可指定。',
    'Node size': '点大小',
    'Save layout': '保存布局',
    'Reset layout': '重置布局',
    'Export image': '导出图片',
    'Story Graph layout saved': '已保存故事图谱布局',
    'Story Graph layout reset': '已重置故事图谱布局',
