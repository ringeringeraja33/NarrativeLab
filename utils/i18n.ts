...
const ZH_CORE: Record<string, string> = {
    ...
    'Character relations need character nodes': '角色关系需要两端都是角色节点',
    ...
    'Each strand becomes one line on the Story Graph. Set a short label, style, and direction.': '每种关系会在资料图谱中显示为一条连线。可设置短标签、样式和方向。',
