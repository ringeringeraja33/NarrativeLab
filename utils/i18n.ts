...
const ZH_CORE: Record<string, string> = {
    ...
    'Open writing tracker': '打开写作追踪',
    'Open writing tracker panel': '打开写作追踪侧栏',
    ...
    'Exclude `%%comment%%` and `<!-- HTML -->` comment bodies. Markdown and HTML syntax are always ignored; only readable prose is counted.': '排除 `%%注释%%` 和 `<!-- HTML -->` 注释正文。Markdown / HTML 标记本身一律不计；只统计读者能读到的正文。',
